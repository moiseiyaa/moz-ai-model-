            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10">
                  <div className="mb-6 p-4 bg-linear-to-br from-primary-500 to-primary-600 rounded-xl shadow-md transform group-hover:scale-110 transition-transform duration-300">
                    {prop.icon}
                  </div>
          ...
          {valueProps.slice(3).map((prop, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10">
                  <div className="mb-6 p-4 bg-linear-to-br from-accent-teal to-primary-600 rounded-xl shadow-md transform group-hover:scale-110 transition-transform duration-300">
                    {prop.icon}
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-primary-600 transition-colors">{prop.title}</h3>
                  <p className="text-gray-700">{prop.description}</p>
